...
class NextFerry extends Component {
  ...
  renderLocation() {
    ...
    this.state.lastPositionLat = this.state.initialPositionLat;
    this.state.lastPositionLong = this.state.initialPositionLong;

    return (
      <View style={styles.container}>
        <ToolbarAndroid style={styles.titleToolBar}
          title="NextFerry"
          actions={[{title: 'Settings', show: 'always'}]}
          onActionSelected={console.log("button click")} />
